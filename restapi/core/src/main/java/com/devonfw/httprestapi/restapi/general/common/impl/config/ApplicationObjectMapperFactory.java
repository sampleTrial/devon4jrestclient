package com.devonfw.httprestapi.restapi.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the restapi application.
 */
