package com.devonfw.httpclient.httpdevon4jclient.general.common.impl.config;
...
/**
 * The MappingFactory class to resolve polymorphic conflicts within the httpdevon4jclient application.
 */
